    ...
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forRoot({
                ...
                password: "admin",
                database: "appmedicos",
                entities: [user_model_1.User, appointment_model_1.Appointment, doctor_model_1.Doctor, patient_model_1.Patient, location_model_1.Location, appointment_status_model_1.AppointmentStatus],
                synchronize: true,
            }),
        ],
