...
@Module({
  imports: [DatabaseModule, UsersModule, AppointmentsModule, DoctorModule, PatientModule, LocationModule, AppointmentStatusModule, UserTypeModule, AuthModule, CalendarModule],
